    ...
    public partial class FrmUpdate : Form
    {
        ...
        public void getData2()
        {
            try
            {
                ...
                listView1.Columns.Add("Name", 210);
          ...
          try
            {
               ...
               string up = @"UPDATE tblProduct SET [UnitPrice]='" + txtUPrice.Text + "' , [Stock]=Convert(int,"+txtQty.Text+") where [ID]='" + txtProductID.Text + "'";
                cm = new SqlCommand(up, cn);             
               
                cm.Parameters.AddWithValue("@Price", txtUPrice.Text);
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtUPrice.Text = listView1.FocusedItem.SubItems[2].Text;
            txtQty.Text= listView1.FocusedItem.SubItems[3].Text;
            txtUPrice.Focus();
